...
export const generations: Generation[] = [
  { id: 1, name: 'Generation I', region: 'Kanto', range: [1, 151], pokemon: gen1Pokemon },
  { id: 2, name: 'Generation II', region: 'Johto', range: [152, 251], pokemon: gen2Pokemon },
  { id: 3, name: 'Generation III', region: 'Hoenn', range: [252, 386], pokemon: gen3Pokemon },
  { id: 4, name: 'Generation IV', region: 'Sinnoh', range: [387, 493], pokemon: gen4Pokemon },
  { id: 5, name: 'Generation V', region: 'Unova', range: [494, 649], pokemon: gen5Pokemon },
  { id: 6, name: 'Generation VI', region: 'Kalos', range: [650, 721], pokemon: gen6Pokemon },
  { id: 7, name: 'Generation VII', region: 'Alola', range: [722, 809], pokemon: gen7Pokemon },
  { id: 8, name: 'Generation VIII', region: 'Galar', range: [810, 905], pokemon: gen8Pokemon },
  { id: 9, name: 'Generation IX', region: 'Paldea', range: [906, 1025], pokemon: gen9Pokemon },
];
...
// Helper to get Pokemon sprite URL (smaller, faster loading)
